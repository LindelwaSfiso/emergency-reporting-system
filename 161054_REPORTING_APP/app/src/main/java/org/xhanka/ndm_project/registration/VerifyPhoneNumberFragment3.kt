...
import org.xhanka.ndm_project.databinding.FragmentPhoneAuthBinding
import java.util.concurrent.TimeUnit

class VerifyPhoneNumberFragment3 : Fragment() {
...
//        }
    ...
    private fun updateUI(
        ...
        when (uiState) {
            ...
            STATE_CODE_SENT -> {
                ...
                binding.detail.text = "R.string.status_code_sent"
            }
            STATE_VERIFY_FAILED -> {
                ...
                binding.detail.text = "R.string.status_verification_failed"
            }
            STATE_VERIFY_SUCCESS -> {
                ...
                disableViews(binding.buttonStartVerification, binding.buttonVerifyPhone,
                    binding.buttonResend, binding.fieldPhoneNumber,
                    binding.fieldVerificationCode)
                binding.detail.text = "R.string.status_verification_succeeded"
            ...
            STATE_SIGN_IN_FAILED ->
                ...
                binding.detail.text = "R.string.status_sign_in_failed"
        ...
        if (user == null) {
            ...
            binding.status.text = "R.string.signed_out"
        } else {
            // Signed in
            ...
            binding.status.text = "R.string.signed_in"
            binding.detail.text = String.format("%s, %d", "getString(R.string.firebase_status_fmt", user.uid)
        }
    }
    ...
    companion object {
        ...
        private const val TEST_NUMBER = "+16505553434"
    }
